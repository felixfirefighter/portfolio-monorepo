...
export const EmptySearchSection: React.FC<Props> = (props) => {
  ...
  return (
    <div className="container py-8">
      <h1 className="font-bold text-3xl text-neutral-900">{title}</h1>
      ...
      <div className="flex h-[calc(100vh-224px)] flex-col items-center justify-center">
        ...
        <h2 className="py-2 font-medium text-neutral-900 text-xl">
          No results found
        </h2>
        <p className="text-neutral-900">Try using different keywords</p>
      </div>
    </div>
  );
};
